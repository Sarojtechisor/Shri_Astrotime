        ...
        <div className={styles.Container}>
          <div className={styles.HomepageSection1}>
            ...
            <div className={styles.WatchImage1}>
              <Image
                src="/Images/Watch-Images/Screenshot (14).png"
                alt="Panchanga Clock Hero"
                width={500}
                height={300}
          ...
          <div className={styles.HomepageSection2}>
            ...
            <div>
              ...
              <p className={styles.SectionParagraph}>
                ...
                This is a cultural, scientific, educative and decorative device. <br />
                <br />
                Shri Astrotime proudly presents the world’s first Panchanga Clock, a
                groundbreaking fusion of ancient wisdom and modern technology. This
                innovative electronic clock goes beyond simply showing the time — it
                beautifully displays essential Panchanga elements such as Nakshatra,
                Rashi, Tithi, Lagna, and more, with rotating dials and pointers that
                resemble a traditional wall clock.
              </p>
          ...
          <div className={styles.HomepageSection3}>
            ...
            <div>
              ...
              <p className={styles.SectionParagraph}>
                ...
                temples and worship places. All festivals of India, special occasions
                like marriage, naming ceremonies, special Poojas, Homas, Vratas, etc.
                are based on Panchanga system of time keeping. This ancient Indian
                system of time keeping, called Panchanga, is used extensively in
                Indian society.
                <br />
                Panchanga Clock helps everyone to get a basic understanding of the
                various elements involved in Panchanga and read out key elements like
                Tithi, Nakshatra, Rashi, Lagna etc., easily. It displays the relative
                positions of the Sun and the Moon w.r.t. Earth’s horizon and also
                w.r.t. the Stars using pointers and dials.
                <br />
                ...
                various festivals and national holidays. It is customized for various
                places depending on latitude and longitude, language and time zones.
                This clock can be used by both sections of society who follow Solar or
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 backdrop-blur-sm pt-1 z-[9999]">
              <div
                className="bg-opacity-30 p-5 rounded-lg shadow-xl w-full max-w-3xl relative z-[10000]"
                id={styles.PopupForm}
              >
                <button
