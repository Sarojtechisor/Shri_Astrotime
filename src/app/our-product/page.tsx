              ...
              <div className={styles.VideoBackground}>
                ...
                <div className={styles.OurProductSection1}>
                  <div>
                    ...
                    <p className={styles.ContentParagraph}>
                      ...
                      normal (Gregorian) date and time. Current Panchanga is displayed
                      by the position of the sun, the moon and the earth at that
                      instant, against the backdrop of fixed stars. The clock serves as
                      a time and calendar device apart from being educational and a
                      decorative item. <br /> Panchanga data in this clock is based on
                      Jagannatha Hora containing accurate Ephemeris and customized
                      in-built algorithms.
                    </p>
                  </div>
                  <div>
                ...
                <div className={styles.OurProductSection2}>
                  ...
                  <div>
                    ...
                    <h6 className={styles.ContentSubHead}>
                      <ul className={styles.ContentListDiv}>
                ...
                <div className={styles.OurProductSection3}>
                    <h1 className={styles.SectionHead}> Product Catalouge</h1>
                    ...
                    <div className={styles.ProductCardDiv}>
                        {
                          Watchcard.map((product, index) => (
                            <div key={index} className={styles.ProductCard}>
                              ...
                              <p className={styles.ProductPrice}>MRP: ₹24,900/- (incl. GST)</p>
                              <button className={styles.ProductCardBtn} onClick={() => setShowPopup(true)}>Buy Now</button>
                            </div>
                          ))
                        }
                    </div>
                    {showPopup && (
                        <div className="fixed inset-0 flex items-center justify-center  bg-opacity-50 backdrop-blur-sm pt-1 z-[9999]" >
                          <div className="bg-opacity-50 p-5 rounded-lg shadow-2xl w-full max-w-3xl relative z-[10000]" id={styles.PopupForm}>
                            <button
